...
public class BookService {
	...
	@Transactional
	public Book createBook(String title, boolean isArchive, boolean isReservable, Date releaseDate, int numPages, boolean available, BMGenre genre) throws IllegalArgumentException {
